...
const Loading = () => {
  return (
    <div className="px-4 sm:px-[25px] lg:px-0">
      <Skeleton className="mt-6 min-h-6 w-full max-w-full lg:min-h-10 lg:w-2/3" />
      <h3 className="my-9 text-32 capitalize">Trending</h3>
      <Skeleton className="min-h-[140px] w-full max-w-full sm:min-h-56 lg:min-h-[230px]" />
      <h3 className="my-9 text-32 capitalize">Recommended for you</h3>
